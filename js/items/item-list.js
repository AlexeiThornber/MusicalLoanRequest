 ...
 */
const itemCategoriesString = ["Sound & Instruments", "Microphones", "Cables"];

export const Items = Object.freeze({
    Sonorisation : Object.freeze({
        FACADE_SCENE: {name : "Façade scène agepoly (2 tops, 2 subs, tâble de mix analogue, 2 pieds)", quantity : 1},
...
export function keyToValueConverter(key, type){
    switch(type){
        case "Sound & Instruments":
            return Items.Sonorisation[key];
        case "Microphones":
            return Items.Micros[key];
        case "Cables":
            return Items.Cables[key];
    }
}

export function keyToCategoryConverter(key){

    for(const [key1, value1] of Object.entries(Items)){
...
export function getItem(key){
    for(let cat of itemCategoriesString){
